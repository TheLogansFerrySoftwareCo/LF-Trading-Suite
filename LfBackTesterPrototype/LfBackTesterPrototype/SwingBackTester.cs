// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BackTester.cs" company="The Logans Ferry Software Co.">
...
namespace LogansFerry.BackTesterPrototype
{
    ...
    public class SwingBackTester
    {
        ...
        private bool IsTodayALongSetup()
        {
            ...
            // For this strategy, we will confirm the setup by verifying that the ADX value
            // is above 25 and that both the ADX and EMA are bullish.
            var isSetupConfirmed = this.Today.Adx > 25.0f
               && this.Today.AdxDirection == PriceDirections.Up
        ...
        {
            return this.FindBestSupportLevel() - 0.01f;
        }
        ...
        private int GetFirstPriorNonInsideDayIndex(int baseIndex)
        {
            ...
            Console.WriteLine("WARNING:  A non-inside day could not be found from the starting index:  " + baseIndex);
